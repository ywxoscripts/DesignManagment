    ...
    local prefixes = {
        ...
        "- Click", "- Hatch", "- Eggs", "- Farm Boss", "- Bosses", "- Farm Sword", "- Swords", "- Farm Maple Tower", 
        "- Gift", "- Claim Credit", "- Rebirth", "- Super Rebirth",
        "- Pull selected sword", "- Fight selected world boss", "- World bosses", "- Fight selected mega boss", "- Mega bosses",
        "- Fight selected player", "- Insert player name", "- Fight player with lowest level [Buggy]", "- Fight player with most wins [Buggy]", 
