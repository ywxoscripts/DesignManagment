...
local prefixes = {
    ...
    "- Attack Aura  |  Hold Firearm", "- Attack Aura Speed  |  Default : 0.065", "- Bigger Heads", "- Collect Powerups", 
    "- Spectate current attacked enemy", "- Circle enemies", "- Teleport Radius  |  Default : 15 Studs", "- Teleport Speed  |  Default : 1.5 Ts", "- Teleport Height  |  Default : 15 Studs",
