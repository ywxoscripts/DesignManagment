...
local prefixes = {
    ...
    "- Weapon", "- Gifts", "- Spin", "- Rebirth", 
    "- Click", "- Dummy Train", "- Dummys", "- ASBD",
    "- Godmode", "- Attack Aura", "- Floor", "- SecretBoss", "- Secret Bosses",
    "- Remove Hatch Animation", "- Hatch", "- Eggs", "- Chest", "- Chests",
